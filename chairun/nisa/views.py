...
from chairuncart.models import Transaksi, DetailTransaksi
...
from chairuncart.forms import ChairunCartAddProductForm
from chairuncart.keranjang import ChairunCart
import datetime
...
def beranda(request):
      ...
      chairuncart_product_form = ChairunCartAddProductForm()
      ...
      context = {
            ...
            "slide": slider,
            "trending":trending, 
            "chairuncart_product_form": chairuncart_product_form,
...
class CheckoutView(View):
      ...
      def post(self, request):
            ...
            checkout = Checkout.objects.create(no_transaksi = no_transaksi,
                                                nama_depan = nama_depan,
                                                nama_belakang=nama_belakang,
                                                alamat = alamat,
                                                provinsi = provinsi,
